...
public class Shader {
    ...
    public Shader(int type, String srcPath) throws IOException {
    	myType = type;
    	try {
    		BufferedReader reader = new BufferedReader(new InputStreamReader(getClass().getResourceAsStream(srcPath)));
